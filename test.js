...
const compress = Promise.promisify(compression.compress);
const isValidCompressed = Promise.promisify(compression.isValidCompressed);
const uncompress = Promise.promisify(compression.uncompress);
const {compressSync, isValidCompressedSync, uncompressSync} = compression;
