var binding = require('bindings')('binding'); // Helper for sharing data between binding in build/ folder
var assert = require('assert'); // Testing inputs for strict data type
